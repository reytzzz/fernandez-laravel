...
<html lang="en">
  ...
  <body>
  	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.html"><small>Ritz</small>Coffee</a>
        ...
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center">
            ...
            <div class="col-md-7 col-sm-12 text-center ftco-animate">
	            ...
	            <p class="breadcrumbs"><span class="mr-2"><a href="{{route('page.home')}}">Home</a></span> <span>Cart</span></p>
            </div>
	    				...
	    				<table class="table">
						    ...
						    <tbody>
						      <tr class="text-center">
						        ...
						        <td class="image-prod"><div class="img" style="background-image:url(../../../landing/images/menu-2.jpg);"></div></td>
						        
						        <td class="product-name">
						        	<h3>Creamy Latte Coffee</h3>
						        	<p>Rich espresso meets silky steamed milk for a smooth, mellow finish.</p>
						        </td>
						      ...
						      <tr class="text-center">
						        ...
						        <td class="image-prod"><div class="img" style="background-image:url(../../../landing/images/Braised\ Chicken\ Legs\ With\ Grapes\ and\ Fennel.jpg);"></div></td>
						        
						        <td class="product-name">
						        	<h3>Braised Chicken Legs</h3>
